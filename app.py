...
# ユーザーインターフェイスの構築
st.title("就活の面接アシスタント")
st.write("就活の面接に対するお悩み相談ができます。")
st.write("模擬面接も出来ますのでご活用下さい。")

user_input = st.text_input("面接に対する悩みを入力してください。", key="user_input", on_change=communicate)
